...
public class CameraSource {
  ...
  private BarcodeScannerProcessor frameProcessor;
  ...
  public CameraSource(Activity activity, CameraView overlay) {
  ...
  public void setMachineLearningFrameProcessor(BarcodeScannerProcessor processor) {
    synchronized (processorLock) {
      cleanScreen();
      if (frameProcessor != null) {
        frameProcessor.stop();
